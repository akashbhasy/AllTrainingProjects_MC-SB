				...
				<div class="row">
					<div class="col">
						<form:input type="text" class="form-control" name="First_Name"
							placeholder="First Name" required="required" path="First_Name" />
					</div>
					<div class="col">
						<form:input type="text" class="form-control" name="Last_Name"
							placeholder="Last Name" required="required" path="Last_Name" />
					</div>
				</div>
			</div>
			<div class="form-group">
				<form:input type="text" class="form-control"
					name="customerAddress" placeholder="Address" required="required" path="customerAddress" />
			</div>
			<div class="form-group">
				<form:input type="email" class="form-control" name="email"
					placeholder="Email" required="required" path= "email" />
			</div>
			<div class="form-group">
				<input type="text" class="form-control" name="username"
					placeholder="username" required="required" path= "username">
			</div>
			<div class="form-group">
